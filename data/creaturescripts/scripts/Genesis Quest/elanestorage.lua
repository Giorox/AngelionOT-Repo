...
local monstName,Storage = "Elane Queen of the Paladins",7445 -- monster name, storage
if isMonster(cid) and string.lower(getCreatureName(cid)) == string.lower(monstName) then
doCreatureSay(cid, "You have set Elane's spirit free from the necromantic curse!", TALKTYPE_ORANGE_1)
