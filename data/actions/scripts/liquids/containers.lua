...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	if(itemEx.uid == 10200 and item.type == 2) then
        doSendMagicEffect(getCreaturePosition(cid), CONST_ME_DRAWBLOOD)
        doTeleportThing(cid, {x=32791, y=32333, z=10})
        doCreatureSay(cid, "Muahahahaha...", TALKTYPE_ORANGE_1, nil, nil, {x=32791, y=32333, z=10})
		doSendMagicEffect({x=32791, y=32333, z=10}, CONST_ME_ENERGYAREA)
